...
class SetUpDialScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        backButton.backbutton(context, "/SetUpDialScreen");
        return Future(() => false);
      },
      child: Scaffold(
                      ...
                      children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          if (dialController.text.isNotEmpty) {
                                            Share.share(dialController.text);
                                          } else {
                                            fluttertost();
                                          }
                                        },
                        ...
                        RichText(
                          text: TextSpan(children: [
                            ...
                            TextSpan(
                              text:
                                  "Your mobile no must be registered with bank",
                              style: GoogleFonts.ibmPlexSansThaiLooped(
                                  color: const Color(0xFF768AAB)),
                            ),
                          ]),
