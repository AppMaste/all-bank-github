...
class PPFCalculationPieChartScreen extends StatefulWidget {
  PPFCalculationPieChartScreen({Key? key}) : super(key: key);

  @override
  State<PPFCalculationPieChartScreen> createState() =>
      _PPFCalculationPieChartScreenState();
}

class _PPFCalculationPieChartScreenState
    extends State<PPFCalculationPieChartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // double bb2 = double.parse(arg[0]);
    final dataMap = <String, double>{
      "Loan (${arg[0]})": aa,
      "Interest (${arg[3]})": arggg,
    };
