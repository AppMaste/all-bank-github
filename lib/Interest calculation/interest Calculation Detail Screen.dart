...
class InterestCalculationDetailScreen extends StatelessWidget {
  const InterestCalculationDetailScreen({Key? key}) : super(key: key);
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  Get.to(() =>  const InterestCalculationPieChartScreen());
                                },
                                child: Stack(
                                  children: [
                                    Container(
