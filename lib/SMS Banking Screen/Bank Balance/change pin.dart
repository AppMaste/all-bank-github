...
class SMSChangePin extends StatelessWidget {
   SMSChangePin({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: ScreenSize.fSize_20()),
                      form3(context, "CHGPIN <New MPIN> <Old MPIN>"),
                      Padding(
                        padding: EdgeInsets.only(left: ScreenSize.fSize_8()),
                        child: Text(
                          "Example : CHGPIN 8956 4567",
                          style: GoogleFonts.ibmPlexSansThaiLooped(
                            color: Colors.grey,
                            fontWeight: FontWeight.bold,
                          ),
                      ...
                      SizedBox(height: ScreenSize.fSize_20()),
                      SMSBankbalance2(context, controller,"asdasdasd"),
                      SizedBox(height: ScreenSize.fSize_20()),
